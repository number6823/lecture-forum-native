    ...
    return (
        <>
            <Pressable
                ...
                <TextComponent
                    className={selectedOptions ? "text-text-default" : "text-secondary-main"}>
            ...
            */}
            {isOpen && (
                <Modal
                    ...
                    animationType={"fade"} // 이 모달창이 뜨고 사라질 떄의 애니메이션 결정
                    ...
                    <Pressable
                        ...
                        {/*
                                ...
                                위에 있는 녀석 뿐만 아니라 아래에 있는 녀석까지 그 클릭이라는 동작이 전파됨
                                    ...
                                    Card를 바로 쓰지 않고 Pressable로 묶어서 이벤트 버블리을 막아줘야 함
                               */}
                        <Pressable
                            className={
                            ...
                            {/*
                                ...
                                ScrollView : 화면에 보여지지 않는 데이터 까지 한꺼번에 렌더링 (계산)
